...
export default function ResultStage(props: ResultStageProps) {
  ...
  useEffect(() => {
    ...
    if (questionId4 === "Sim") {
      specialNeedsSelected.push(
        specialNeeds.find((it) => it.name === "Problemas Cardíacos ou Pressão Alta")!
      );
    }
    ...
    if (questionId5 === "Sim") {
      specialNeedsSelected.push(specialNeeds.find((it) => it.name === "Diabetes")!);
    }
    ...
    if (questionId12 === "Sim") {
      specialNeedsSelected.push(specialNeeds.find((it) => it.name === "Ansiedade")!);
    }
