...
export const EVO_API_USERNAME =
  process.env.EVO_API_USERNAME || MissingEnv("EVO_API_USERNAME");
export const EVO_API_PASSWORD =
  process.env.EVO_API_PASSWORD || MissingEnv("EVO_API_PASSWORD");
